...
class MessageController extends AbstractController
{
    ...
    public function index(Request $request, Conversation $conversation)
    {
        ...
        // $messagesList = $messageRepository->findBy(array('conversation' => $conversation->getId()), array('id' => 'DESC'));
        // $participantList = $participantRepository->findBy(array('conversation' => $conversation->getId()));
